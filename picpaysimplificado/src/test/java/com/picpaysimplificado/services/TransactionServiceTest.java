...
class TransactionServiceTest {
    ...
    @Autowired
    @InjectMocks // Injeta todos os mock acimas citados (Caso forem ser usados)
    private TransactionService transactionService;

    // Executa antes de iniciar os teste unitários
    @BeforeEach
    void setup(){
    ...
    @Test
    @DisplayName("Should create transaction sucessfully when averything is OK")
